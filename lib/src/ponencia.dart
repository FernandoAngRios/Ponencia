...
class Ponencia extends StatefulWidget {
  const Ponencia({Key? key, this.restorationId}) : super(key: key);
...
class _RegistroState extends State<Ponencia> {
  var _lis = [
    'Conferencia',
    'Curso',
    'Mentoria',
        ...
        children: <Widget>[
          Expanded(
            child: RaisedButton(
              ...
              onPressed: () {
                Navigator.of(context).pushNamed('ponencia2');
              },
            ),
          ),
        ],
